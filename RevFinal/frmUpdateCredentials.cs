...
namespace Design_Document_Mock_Up
{
    public partial class frmUpdateCredentials : Form
    {
        ...
        private void btn_addDonor_Click(object sender, EventArgs e)
        {
            ...
            string warning = "This will overwrite your previous credentials. Hit Yes to proceed. ";
            string notice = " Notice";
            MessageBoxButtons stuff = MessageBoxButtons.YesNo;
            DialogResult dialog;
            dialog = MessageBox.Show(warning, notice, stuff);

    ...
    public partial class frmDonorSplash : Form
    {
        ...
        private void fontNScheme()
        {
            ...
            if (setScheme == 1)
            {
                ...
                btn_appmntSched.BackColor = Color.DarkGray;
                btn_changePic.BackColor = Color.DarkGray;
                btn_UpdateCredentials.BackColor = Color.DarkGray;
                btn_sendReminder.BackColor = Color.DarkGray;
                btn_printReminder.BackColor = Color.DarkGray;
                btn_WindowScheme.BackColor = Color.DarkGray;
                btn_Logout.BackColor = Color.DarkGray;
            }
            if (setScheme == 2)
            {
                this.BackColor = Color.PowderBlue;
                btn_appmntSched.BackColor = Color.Aqua;
                btn_changePic.BackColor = Color.Aqua;
                btn_UpdateCredentials.BackColor = Color.Aqua;
                btn_sendReminder.BackColor = Color.Aqua;
                btn_printReminder.BackColor = Color.Aqua;
                btn_WindowScheme.BackColor = Color.Aqua;
                btn_Logout.BackColor = Color.Aqua;
            }
            if (setScheme == 3)
            {
                this.BackColor = Color.Black;
                btn_appmntSched.BackColor = Color.DimGray;
                btn_changePic.BackColor = Color.DimGray;
                btn_UpdateCredentials.BackColor = Color.DimGray;
                btn_sendReminder.BackColor = Color.DimGray;
                btn_printReminder.BackColor = Color.DimGray;
                btn_WindowScheme.BackColor = Color.DimGray;
